...
#coxph(formula = Surv(death) ~ ., data = grouped_data)
#plot(survfit(Surv(death) ~ group, data = grouped_data), 
#     lty = 1:2, mark.time = FALSE, ylab = "Probability", xlab = "Survival Time in Days")

#clogit(death~group, data = grouped_data)
```